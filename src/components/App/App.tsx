...
const SearchListContainer = React.lazy(
  () => import("../Containers/MovieList/SearchListContainer")
);
const GenreListContainer = React.lazy(
  () => import("../Containers/MovieList/GenreListContainer")
);
const MoviePageContainer = React.lazy(
  () => import("../Containers/MoviePageContainer")
);
const CreditsContainer = React.lazy(
  () => import("../Containers/CreditsContainer")
);
...
const App = ({
  ...
  useEffect(() => {
    ...
    if (location.pathname !== "/genres") {
      if (genresId.length > 0) clearGenres();
    }
  }, [location.pathname]);

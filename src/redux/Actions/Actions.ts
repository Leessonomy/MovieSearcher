...
export const actions = {
    ...
    getSimilarMovies: (similarMovies: object[]) => createAction(ActionType.GET_SIMILAR_MOVIES, similarMovies),
    getGallery: (gallery: object[]) => createAction(ActionType.GET_GALLERY, gallery),
    ///
    getMoviesSucces: (movies: object[]) => createAction(ActionType.GET_MOVIES, movies),
    getMoviesWithGenreSucces: (movies: object[]) => createAction(ActionType.GET_MOVIE_WITH_GENRE, movies),
    getSearchingSucces: (movies: object[]) => createAction(ActionType.GET_SEARCHING_MOVIES, movies),
    ///
